 ...
 * @author damA
 */
public class add_incidencia_tec extends javax.swing.JDialog {
     ...
     */
    public add_incidencia_tec(javax.swing.JDialog parent, boolean modal, String user) {
        super(parent, modal);
    ...
    private void insertarIncidencia() {
        ...
        String[] ur = estado.toString().split(" - ");
        String urg = ur[0];
        ...
        try {
            PreparedStatement ps = conexion.prepareStatement("INSERT INTO man_incidencias(id_profesor_crea, descripcion, desc_tecnica, horas, estado, fecha, fecha_ini_rep, fecha_fin_rep, nivel_urgencia id_ubicacion, observaciones) "
                    + "VALUES('" +id+ "','" +descripcion+ "','"+descrTecnico+"','"+horas+"'," +fecha+ "','"+f_ini+"','"+f_fin+"','"+urg+"','" +ubis+ "','" + observaciones + "')");
            ps.executeUpdate();
    ...
    private void rellenar_urgencia() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                jcbo_ubis.addItem(rs.getString("id_urgencia") + " - " + rs.getString("urgencia"));
            }
